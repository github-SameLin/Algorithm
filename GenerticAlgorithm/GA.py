...
class GeneticAlgorithm:
    ...
    def run(self):
        ...
        # 路线数组
        lines = [[i for i in range(1, self.mans+1)] for i in range(self.rows)]
        ...
        while t < self.times:
            ...
            while nl < self.rows:
                ...
                if random.random() < self.JCL and nl + 1 < self.rows:
                    ...
                    f = random.randint(0, self.mans-1)
                    l = random.randint(0, self.mans-1)
    ...
    def clMountain(self, line):
        ...
        while i < self.PSCS:
            f = random.randint(0, self.mans-1)
            n = random.randint(0, self.mans-1)
